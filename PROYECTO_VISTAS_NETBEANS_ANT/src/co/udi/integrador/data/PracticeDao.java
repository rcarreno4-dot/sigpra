...
public class PracticeDao {
    ...
    private static final String SQL_INSERT_PRACTICE = """
            INSERT INTO practica (
                ...
                periodo, fecha_inicio, fecha_fin, estado, horas_objetivo, horas_acumuladas, fecha_registro
            ) VALUES (
                NULL, ?, ?, ?, ?, ?, ?, 'EN_CURSO', 160, 0, SYSTIMESTAMP
            )
            """;
    ...
    public List<ComboItem> listDirectors() throws SQLException {
        ...
        try (Connection cn = DatabaseConnection.getConnection()) {
            ...
            return listCombo(cn, sqlTemplate.formatted(directorTable));
        }
    }
    ...
    private List<ComboItem> listCombo(String sql) throws SQLException {
        try (Connection cn = DatabaseConnection.getConnection()) {
            return listCombo(cn, sql);
        }
    }

    private List<ComboItem> listCombo(Connection cn, String sql) throws SQLException {
