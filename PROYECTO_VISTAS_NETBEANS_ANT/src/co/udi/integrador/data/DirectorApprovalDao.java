...
public class DirectorApprovalDao {
    private static final String SQL_PENDING_TEMPLATE = """
            ...
            JOIN %s dp ON dp.programa = s.programa
            LEFT JOIN (
    ...
    public DefaultTableModel listPendingApprovals(long directorId) throws SQLException {
        ...
        try (Connection cn = DatabaseConnection.getConnection();
             PreparedStatement ps = cn.prepareStatement(SQL_PENDING_TEMPLATE.formatted(
                     DbSchemaHelper.resolveDirectorTable(cn)))) {
