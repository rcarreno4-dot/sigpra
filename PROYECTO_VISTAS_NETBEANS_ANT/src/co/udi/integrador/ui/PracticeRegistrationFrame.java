...
public class PracticeRegistrationFrame extends BaseFrame {
    ...
    private void buildBody() {
        ...
        card.add(UITheme.bodyLabel("Director"));
        ...
        var refreshBtn = UITheme.secondaryButton("Actualizar listas");
        refreshBtn.addActionListener(e -> reloadCombos());
    ...
    private void reloadCombos() {
        ...
        try {
            ...
            fillStudentFromCombo();
            JOptionPane.showMessageDialog(this,
                    "Listas actualizadas. Ya puedes asignar estudiantes nuevos.",
